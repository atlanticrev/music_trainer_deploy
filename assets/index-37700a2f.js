...
const styles$l = "x-icon {\n  display: block;\n  width: 24px;\n  height: 24px;\n}\nx-icon.active svg path {\n  fill: #43cbc5;\n}\nsvg {\n  width: 100%;\n  height: 100%;\n}\nsvg path {\n  fill: #636363;\n  transition: all ease-out 0.25s;\n}";
...
customElements.define(getTagNameByCtor(CreateIcon), CreateIcon);
...
customElements.define(getTagNameByCtor(FavouritesIcon), FavouritesIcon);
...
customElements.define(getTagNameByCtor(SearchIcon), SearchIcon);
...
customElements.define(getTagNameByCtor(MenuIcon), MenuIcon);
...
customElements.define(getTagNameByCtor(ExercisesIcon), ExercisesIcon);
...
customElements.define(getTagNameByCtor(UtilsIcon), UtilsIcon);
...
customElements.define(getTagNameByCtor(SettingsIcon), SettingsIcon);
...
customElements.define(getTagNameByCtor(CrossIcon), CrossIcon);
...
customElements.define(getTagNameByCtor(PlayIcon), PlayIcon);
...
customElements.define(getTagNameByCtor(PauseIcon), PauseIcon);
                ...
                children: [
                  {
                    ...
                    children: [
                      ...
                      ...KEYS_SIGNS_QUANTITIES.map((signsQty) => ({
                        tagName: "option",
                        attrs: { value: signsQty.value },
                        children: signsQty.label
                      }))
                    ]
                  },
                  {
